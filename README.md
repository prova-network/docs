...
* [**HTTP API**](api/README.md) — same endpoints from any language, any runtime.

For programmatic / on-chain workflows, the [TypeScript SDK](sdk/README.md) gives you a typed surface.
