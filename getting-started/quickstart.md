...
# Retrieve
prova get bafy…q4kr -o ./dist.tar.gz
```
...
(In practice, use the [SDK](../sdk/README.md) so you don't have to do the cid math yourself.)
...
* [Building on Prova](../sdk/README.md) — the TypeScript SDK.
